function seeCoursesFront() {
    const verColunaUmFront = document.querySelector(".colun-one-front");
    verColunaUmFront.classList.add('active');
    ...
    const fecharColunaDoisBack = document.querySelector(".colun-two-back");
    fecharColunaDoisBack.classList.remove('active');
...
function seeCoursesBack() {
    const verColunaUmBack = document.querySelector(".colun-one-back");
    verColunaUmBack.classList.add('active');
    ...
    const fecharColunaDoisFront = document.querySelector(".colun-two-front");
    fecharColunaDoisFront.classList.remove('active');
